...
private:
    ...
    void validerPack(int idPlusVendu,
                     int idMoinsVendu,
                     QGroupBox *carte,
                     const QJsonObject &packData);
    void rejeterPack(QGroupBox *carte);
    void modifierPack(QGroupBox *carte,
                      QSpinBox *spinBox,
                      QLabel *labelPrixPack,
                      double prixPlusVendu,
                      double prixMoinsVendu,
                      QJsonObject packData); // Nouvelle méthode pour modifier le pack
