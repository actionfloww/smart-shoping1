...
#include "../../../../../../../integration/serialmanager.h"
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->idChecked((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        ...
        {
            using _t = void (SerialManager::*)(const QString & , bool , const QString & );
            if (_t _q_method = &SerialManager::idChecked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialManager::idChecked(const QString & _t1, bool _t2, const QString & _t3)
{
