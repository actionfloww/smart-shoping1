...
//arduino
void MainWindow::handleIdChecked(const QString &id, bool exists, const QString &etage) {
    QString message;
    if (exists) {
...
void MainWindow::on_sup_clicked()
{
    ...
    void MainWindow::on_pushButton_Map_clicked()
    {
        ...
        QUrl sourceUrl = QUrl("/Users/ranim/Desktop/Projet qT/Projet qT/ranim/projet/map.qml");
    ...
    void MainWindow::onLocationSelected(double latitude, double longitude)
    {
    ...
    void MainWindow::on_Meilleur_clicked()
    {
        Magasin m;
    ...
    void MainWindow::on_bt_go_tostat_clicked()
    {
    ...
    void MainWindow::on_bt_acceuil_clicked()
    {
        ui->page_magasin_stat->hide();
    ...
    void MainWindow::on_lineEdit_5_textChanged(const QString &text)
    {
        QString choix=ui->choix->currentText();
        ui->tableView->setModel(magasin.chercher(choix,text));
    }
